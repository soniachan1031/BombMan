...
@.str.6 = private unnamed_addr constant [42 x i8] c"crc64e66c7aca69b4ea6e/ActivityBombManGame\00", align 16
@.str.7 = private unnamed_addr constant [41 x i8] c"javax/microedition/khronos/egl/EGLConfig\00", align 16
@.str.8 = private unnamed_addr constant [42 x i8] c"javax/microedition/khronos/egl/EGLContext\00", align 16
@.str.9 = private unnamed_addr constant [42 x i8] c"javax/microedition/khronos/egl/EGLDisplay\00", align 16
@.str.10 = private unnamed_addr constant [42 x i8] c"javax/microedition/khronos/egl/EGLSurface\00", align 16
@.str.11 = private unnamed_addr constant [35 x i8] c"javax/microedition/khronos/egl/EGL\00", align 16
@.str.12 = private unnamed_addr constant [37 x i8] c"javax/microedition/khronos/egl/EGL10\00", align 16
@.str.13 = private unnamed_addr constant [24 x i8] c"android/widget/EditText\00", align 16
@.str.14 = private unnamed_addr constant [24 x i8] c"android/widget/TextView\00", align 16
@.str.15 = private unnamed_addr constant [30 x i8] c"android/util/AndroidException\00", align 16
@.str.16 = private unnamed_addr constant [28 x i8] c"android/util/DisplayMetrics\00", align 16
@.str.17 = private unnamed_addr constant [26 x i8] c"android/util/AttributeSet\00", align 16
@.str.18 = private unnamed_addr constant [17 x i8] c"android/util/Log\00", align 16
@.str.19 = private unnamed_addr constant [28 x i8] c"android/provider/MediaStore\00", align 16
@.str.20 = private unnamed_addr constant [34 x i8] c"android/provider/MediaStore$Audio\00", align 16
@.str.21 = private unnamed_addr constant [40 x i8] c"android/provider/MediaStore$Audio$Media\00", align 16
@.str.22 = private unnamed_addr constant [35 x i8] c"android/provider/MediaStore$Images\00", align 16
@.str.23 = private unnamed_addr constant [41 x i8] c"android/provider/MediaStore$Images$Media\00", align 16
@.str.24 = private unnamed_addr constant [26 x i8] c"android/provider/Settings\00", align 16
@.str.25 = private unnamed_addr constant [41 x i8] c"android/provider/Settings$NameValueTable\00", align 16
@.str.26 = private unnamed_addr constant [51 x i8] c"android/provider/Settings$SettingNotFoundException\00", align 16
@.str.27 = private unnamed_addr constant [33 x i8] c"android/provider/Settings$System\00", align 16
@.str.28 = private unnamed_addr constant [22 x i8] c"android/os/BaseBundle\00", align 16
@.str.29 = private unnamed_addr constant [17 x i8] c"android/os/Build\00", align 16
@.str.30 = private unnamed_addr constant [25 x i8] c"android/os/Build$VERSION\00", align 16
@.str.31 = private unnamed_addr constant [18 x i8] c"android/os/Bundle\00", align 16
@.str.32 = private unnamed_addr constant [19 x i8] c"android/os/Handler\00", align 16
@.str.33 = private unnamed_addr constant [18 x i8] c"android/os/Looper\00", align 16
@.str.34 = private unnamed_addr constant [20 x i8] c"android/os/Vibrator\00", align 16
@.str.35 = private unnamed_addr constant [16 x i8] c"android/net/Uri\00", align 16
@.str.36 = private unnamed_addr constant [27 x i8] c"android/media/AudioManager\00", align 16
@.str.37 = private unnamed_addr constant [26 x i8] c"android/media/MediaPlayer\00", align 16
@.str.38 = private unnamed_addr constant [47 x i8] c"android/media/MediaPlayer$OnCompletionListener\00", align 16
@.str.39 = private unnamed_addr constant [63 x i8] c"mono/android/media/MediaPlayer_OnCompletionListenerImplementor\00", align 16
@.str.40 = private unnamed_addr constant [37 x i8] c"android/hardware/SensorEventListener\00", align 16
@.str.41 = private unnamed_addr constant [24 x i8] c"android/hardware/Sensor\00", align 16
@.str.42 = private unnamed_addr constant [29 x i8] c"android/hardware/SensorEvent\00", align 16
@.str.43 = private unnamed_addr constant [31 x i8] c"android/hardware/SensorManager\00", align 16
...
@.str.53 = private unnamed_addr constant [28 x i8] c"android/app/KeyguardManager\00", align 16
@.str.54 = private unnamed_addr constant [33 x i8] c"android/view/ContextThemeWrapper\00", align 16
@.str.55 = private unnamed_addr constant [21 x i8] c"android/view/Display\00", align 16
@.str.56 = private unnamed_addr constant [25 x i8] c"android/view/InputDevice\00", align 16
@.str.57 = private unnamed_addr constant [24 x i8] c"android/view/InputEvent\00", align 16
@.str.58 = private unnamed_addr constant [36 x i8] c"android/view/SurfaceHolder$Callback\00", align 16
@.str.59 = private unnamed_addr constant [27 x i8] c"android/view/SurfaceHolder\00", align 16
@.str.60 = private unnamed_addr constant [25 x i8] c"android/view/ViewManager\00", align 16
@.str.61 = private unnamed_addr constant [27 x i8] c"android/view/WindowManager\00", align 16
@.str.62 = private unnamed_addr constant [29 x i8] c"android/view/KeyCharacterMap\00", align 16
@.str.63 = private unnamed_addr constant [22 x i8] c"android/view/KeyEvent\00", align 16
@.str.64 = private unnamed_addr constant [25 x i8] c"android/view/MotionEvent\00", align 16
@.str.65 = private unnamed_addr constant [38 x i8] c"android/view/OrientationEventListener\00", align 16
@.str.66 = private unnamed_addr constant [21 x i8] c"android/view/Surface\00", align 16
@.str.67 = private unnamed_addr constant [25 x i8] c"android/view/SurfaceView\00", align 16
@.str.68 = private unnamed_addr constant [18 x i8] c"android/view/View\00", align 16
@.str.69 = private unnamed_addr constant [34 x i8] c"android/view/View$OnTouchListener\00", align 16
@.str.70 = private unnamed_addr constant [23 x i8] c"android/view/ViewGroup\00", align 16
@.str.71 = private unnamed_addr constant [36 x i8] c"android/view/ViewGroup$LayoutParams\00", align 16
@.str.72 = private unnamed_addr constant [20 x i8] c"android/view/Window\00", align 16
@.str.73 = private unnamed_addr constant [27 x i8] c"android/view/WindowMetrics\00", align 16
@.str.74 = private unnamed_addr constant [40 x i8] c"mono/android/runtime/InputStreamAdapter\00", align 16
@.str.75 = private unnamed_addr constant [31 x i8] c"mono/android/runtime/JavaArray\00", align 16
@.str.76 = private unnamed_addr constant [35 x i8] c"android/runtime/JavaProxyThrowable\00", align 16
@.str.77 = private unnamed_addr constant [41 x i8] c"mono/android/runtime/OutputStreamAdapter\00", align 16
@.str.78 = private unnamed_addr constant [24 x i8] c"android/graphics/Bitmap\00", align 16
@.str.79 = private unnamed_addr constant [31 x i8] c"android/graphics/Bitmap$Config\00", align 16
@.str.80 = private unnamed_addr constant [31 x i8] c"android/graphics/BitmapFactory\00", align 16
@.str.81 = private unnamed_addr constant [39 x i8] c"android/graphics/BitmapFactory$Options\00", align 16
@.str.82 = private unnamed_addr constant [24 x i8] c"android/graphics/Canvas\00", align 16
@.str.83 = private unnamed_addr constant [23 x i8] c"android/graphics/Paint\00", align 16
@.str.84 = private unnamed_addr constant [23 x i8] c"android/graphics/Point\00", align 16
@.str.85 = private unnamed_addr constant [22 x i8] c"android/graphics/Rect\00", align 16
@.str.86 = private unnamed_addr constant [34 x i8] c"android/content/BroadcastReceiver\00", align 16
@.str.87 = private unnamed_addr constant [32 x i8] c"android/content/ContentResolver\00", align 16
@.str.88 = private unnamed_addr constant [28 x i8] c"android/content/ContentUris\00", align 16
@.str.89 = private unnamed_addr constant [24 x i8] c"android/content/Context\00", align 16
@.str.90 = private unnamed_addr constant [31 x i8] c"android/content/ContextWrapper\00", align 16
@.str.91 = private unnamed_addr constant [49 x i8] c"android/content/DialogInterface$OnCancelListener\00", align 16
@.str.92 = private unnamed_addr constant [65 x i8] c"mono/android/content/DialogInterface_OnCancelListenerImplementor\00", align 16
@.str.93 = private unnamed_addr constant [48 x i8] c"android/content/DialogInterface$OnClickListener\00", align 16
@.str.94 = private unnamed_addr constant [64 x i8] c"mono/android/content/DialogInterface_OnClickListenerImplementor\00", align 16
@.str.95 = private unnamed_addr constant [32 x i8] c"android/content/DialogInterface\00", align 16
@.str.96 = private unnamed_addr constant [23 x i8] c"android/content/Intent\00", align 16
@.str.97 = private unnamed_addr constant [29 x i8] c"android/content/IntentFilter\00", align 16
@.str.98 = private unnamed_addr constant [40 x i8] c"android/content/res/AssetFileDescriptor\00", align 16
@.str.99 = private unnamed_addr constant [33 x i8] c"android/content/res/AssetManager\00", align 16
@.str.100 = private unnamed_addr constant [34 x i8] c"android/content/res/Configuration\00", align 16
@.str.101 = private unnamed_addr constant [30 x i8] c"android/content/res/Resources\00", align 16
@.str.102 = private unnamed_addr constant [34 x i8] c"android/content/pm/PackageManager\00", align 16
@.str.103 = private unnamed_addr constant [35 x i8] c"android/content/pm/ApplicationInfo\00", align 16
@.str.104 = private unnamed_addr constant [35 x i8] c"android/content/pm/PackageItemInfo\00", align 16
@.str.105 = private unnamed_addr constant [28 x i8] c"java/util/function/Consumer\00", align 16
@.str.106 = private unnamed_addr constant [31 x i8] c"java/util/function/IntConsumer\00", align 16
@.str.107 = private unnamed_addr constant [30 x i8] c"java/util/concurrent/Executor\00", align 16
@.str.108 = private unnamed_addr constant [30 x i8] c"java/nio/channels/FileChannel\00", align 16
@.str.109 = private unnamed_addr constant [51 x i8] c"java/nio/channels/spi/AbstractInterruptibleChannel\00", align 16
@.str.110 = private unnamed_addr constant [23 x i8] c"java/io/FileDescriptor\00", align 16
@.str.111 = private unnamed_addr constant [24 x i8] c"java/io/FileInputStream\00", align 16
@.str.112 = private unnamed_addr constant [18 x i8] c"java/io/Closeable\00", align 16
@.str.113 = private unnamed_addr constant [20 x i8] c"java/io/InputStream\00", align 16
@.str.114 = private unnamed_addr constant [20 x i8] c"java/io/IOException\00", align 16
@.str.115 = private unnamed_addr constant [21 x i8] c"java/io/OutputStream\00", align 16
@.str.116 = private unnamed_addr constant [20 x i8] c"java/io/PrintWriter\00", align 16
@.str.117 = private unnamed_addr constant [21 x i8] c"java/io/StringWriter\00", align 16
@.str.118 = private unnamed_addr constant [15 x i8] c"java/io/Writer\00", align 1
@.str.119 = private unnamed_addr constant [16 x i8] c"java/lang/Class\00", align 16
@.str.120 = private unnamed_addr constant [15 x i8] c"java/lang/Enum\00", align 1
@.str.121 = private unnamed_addr constant [16 x i8] c"java/lang/Error\00", align 16
@.str.122 = private unnamed_addr constant [20 x i8] c"java/lang/Exception\00", align 16
@.str.123 = private unnamed_addr constant [23 x i8] c"java/lang/CharSequence\00", align 16
@.str.124 = private unnamed_addr constant [19 x i8] c"java/lang/Runnable\00", align 16
@.str.125 = private unnamed_addr constant [17 x i8] c"java/lang/Object\00", align 16
@.str.126 = private unnamed_addr constant [28 x i8] c"java/lang/StackTraceElement\00", align 16
...
@.str.131 = private unnamed_addr constant [25 x i8] c"mono/android/TypeManager\00", align 16
